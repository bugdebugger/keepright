...
query("
	CREATE UNLOGGED TABLE _tmp_way_tags (
	id serial NOT NULL,
...
function process_tag($k, $v, $check_strictly, $db1, $db2, $db4) {
	...
	query("
		CREATE UNLOGGED TABLE _tmp_way_nodes3 (
		way_id bigint NOT NULL,
	...
	query("
		CREATE UNLOGGED TABLE _tmp_way_nodes (
		way_id bigint NOT NULL,
		node_id bigint NOT NULL)
	", $db1, false);
	query("
	...
	query("
		CREATE UNLOGGED TABLE _tmp_members_ways (
	...
	query("
		CREATE UNLOGGED TABLE _tmp_members_nodes (
	...
	query("
		CREATE UNLOGGED TABLE _tmp_members (
		way_id bigint NOT NULL default 0,

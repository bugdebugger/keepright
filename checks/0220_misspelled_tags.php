...
$false_positives = array(
	...
	array('lanes', 'lines'),
	array('lawyer', 'layer'),
	array('icn_ref', 'lcn_ref', 'lwn_ref', 'loc_ref', 'ncn_ref', 'nwn_ref', 'rcn_ref', 'rhn_ref', 'rin_ref', 'rwn_ref'),
...
$never_complain_about = "
	...
	prefix LIKE 'access:conditional:=%' OR 
	prefix LIKE 'addr:alternatenumber:=%' OR
	prefix LIKE 'addr:conscriptionnumber:=%' OR
	prefix LIKE 'addr:district:=%' OR 
	prefix LIKE 'addr:door:=%' OR 
	prefix LIKE 'addr:flats:=%' OR 
	prefix LIKE 'addr:full:=%' OR
	prefix LIKE 'addr:housenumber:=%' OR
	prefix LIKE 'addr:postcode:=%' OR
	prefix LIKE 'addr:quarter:=%' OR 
	prefix LIKE 'adr_les:=%' OR 
	prefix LIKE 'aims-id:=%' OR
	prefix LIKE 'AND_nosr_r:=%' OR
	prefix LIKE 'AND_a_nosr_r:=%' OR
	prefix LIKE 'atm_ref:=%' OR
	prefix LIKE 'bicycle:conditional:=%' OR 
	prefix LIKE 'bridge_ref:=%' OR
	prefix LIKE 'building:foundation_height:=%' OR 
	prefix LIKE 'building:levelPlan:=%' OR 
	prefix LIKE 'buildingpart:verticalpassage:floorrange:=%' OR 
	prefix LIKE 'building:project:=%' OR 
	prefix LIKE 'bus_routes:=%' OR
	prefix LIKE 'canvec:uuid:=%' OR
	prefix LIKE 'capacity:=%' OR
	prefix LIKE 'capacity:note:=%' OR 
	prefix LIKE 'capacity:persons:=%' OR
	prefix LIKE 'catastro:ref:=%' OR 
	prefix LIKE 'cave:ref:=%' OR 
	prefix LIKE 'code:=%' OR
	prefix LIKE 'collection_plate:=%' OR 
	prefix LIKE 'collection_times:=%' OR
	prefix LIKE 'color:=%' OR
	prefix LIKE 'colour:=%' OR
	prefix LIKE 'comment:=%' OR
	prefix LIKE 'contact:phone:=%' OR 
	prefix LIKE 'created_by:=%' OR
	prefix LIKE 'dcgis:propid:=%' OR
	prefix LIKE 'design:ref:=%' OR 
	prefix LIKE 'destination:int_ref:=%' OR 
	prefix LIKE 'destination:ref:=%' OR 
	prefix LIKE 'distance:=%' OR
	prefix LIKE 'fdot:ref:=%' OR
	prefix LIKE 'FDOT_ref:=%' OR
	prefix LIKE 'fhrs:local_authority_id:=%' OR 
	prefix LIKE 'fire_hydrant:couplings:=%' OR 
	prefix LIKE 'fixme:=%' OR
	prefix LIKE 'Fixme:=%' OR
	prefix LIKE 'FIXME:=%' OR
	prefix LIKE 'foot:conditional:=%' OR 
	...
	prefix LIKE 'goods:lanes:conditional:=%' OR 
	prefix LIKE 'GPT:ref:=%' OR 
	prefix LIKE 'grades:=%' OR
	prefix LIKE 'gsm:cellid:=%' OR 
	prefix LIKE 'guideposted_leads_to_ref:=%' OR 
	prefix LIKE 'height:source:=%' OR 
	prefix LIKE 'hgv:conditional:=%' OR 
	prefix LIKE 'hgv:lanes:conditional:=%' OR 
	prefix LIKE 'highway:category:=%' OR 
	prefix LIKE 'history:=%' OR
	prefix LIKE 'HOJA:=%' OR 
	prefix LIKE 'Householdcode:=%' OR 
	prefix LIKE 'HouseholdCode:=%' OR 
	prefix LIKE 'HZBGEW:=%' OR 
	...
	prefix LIKE 'is_in:catastro:ref:=%' OR 
	prefix LIKE 'is_in:neighbourhood:=%' OR 
	...
	prefix LIKE 'local_ref:=%' OR 
	prefix LIKE 'lte:cellid:=%' OR 
	prefix LIKE 'lte:eNB:=%' OR 
	prefix LIKE 'lte:LAC:=%' OR 
	...
	prefix LIKE 'maxspeed:forward:conditional:=%' OR 
	prefix LIKE 'maxspeed:hgv:conditional:=%' OR 
	prefix LIKE 'maxspeed:hgv:contitional:=%' OR 
	prefix LIKE 'maxspeed:lanes:=%' OR
	prefix LIKE 'maxstay:=%' OR 
	prefix LIKE 'maxweight:conditional:=%' OR 
	prefix LIKE 'MGRS:=%' OR
	prefix LIKE 'minspeed:=%' OR
	prefix LIKE 'minspeed:conditional:=%' OR
	prefix LIKE 'minspeed:lanes:=%' OR
	prefix LIKE 'motorcycle:conditional:=%' OR 
	prefix LIKE 'motor_vehicle:conditional:=%' OR 
	...
	prefix LIKE 'operator:ref:=%' OR 
	prefix LIKE 'osak:identifier:=%' OR
	prefix LIKE 'overtaking:hgv:conditional:=%' OR 
	prefix LIKE 'overtaking:trailer:conditional:=%' OR 
	prefix LIKE 'P_S_COMM:=%' OR
	prefix LIKE 'paved:date:lanes:=%' OR 
	prefix LIKE 'pcode:=%' OR
	prefix LIKE 'PFM:garmin_type:=%' OR
	prefix LIKE 'photo_url:=%' OR
	prefix LIKE 'pipeline:ref:=%' OR 
	prefix LIKE 'pipeline:ref:1:=%' OR 
	prefix LIKE 'pipeline:ref:2:=%' OR 
	prefix LIKE 'plant:output:electricity:=%' OR 
	prefix LIKE 'position:=%' OR 
	prefix LIKE 'position:1:=%' OR 
	prefix LIKE 'position:2:=%' OR 
	prefix LIKE 'position:3:=%' OR 
	prefix LIKE 'position:4:=%' OR 
	prefix LIKE 'proposed:ref:=%' OR 
	prefix LIKE 'railway:track_ref:=%' OR 
	prefix LIKE 'rating:=%' OR 
	prefix LIKE 'ref:%' OR
	prefix LIKE 'ref:isil:=%' OR
	prefix LIKE 'ref_catastral:=%' OR
	prefix LIKE 'ref_no:=%' OR
	prefix LIKE 'ref_num:=%' OR
	prefix LIKE 'ref_old:=%' OR 
	prefix LIKE 'REFCAT:=%' OR 
	...
	prefix LIKE 'share_taxi:opening_hours:=%' OR 
	...
	prefix LIKE 'traffic_sign:backward:=%' OR 
	prefix LIKE 'traffic_sign:forward:=%' OR 
	prefix LIKE 'ts_codigo:=%' OR
	prefix LIKE 'umts:cellid:=%' OR 
	prefix LIKE 'umts:LAC:=%' OR 
	prefix LIKE 'umts:PSC:=%' OR 
	prefix LIKE 'UNIDAD_MAN:=%' OR
	prefix LIKE 'vehicle:conditional:=%' OR 
	prefix LIKE 'was:maxspeed:=%' OR 
	prefix LIKE 'waterway:kilometer:=%' OR
	prefix LIKE 'website:=%' OR
	prefix LIKE 'width:=%' OR
	prefix LIKE 'width:lanes' OR

...
query("
	...
	WHERE wt.k='highway' AND
		...
		'raceway', 'preproposed', 'proposed', 'construction',
...
query("
	CREATE UNLOGGED TABLE _tmp_jpartners (
...
query("
	CREATE UNLOGGED TABLE _tmp_sharp_angles (
		junction_id bigint NOT NULL,
...
query("
	CREATE UNLOGGED TABLE _tmp_wn2 (
		way_id bigint NOT NULL,
		sequence_id integer NOT NULL,
